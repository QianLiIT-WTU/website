...
<body>
	<div class="wrapper">
		<div class="upload-source">
			<form class="uploadPicture" action="${pageContext.request.contextPath }/source/uploadFile" method="post" enctype="multipart/form-data">
				<h1>上传文件</h1>
				<div class="post-item">
					<div class="title">选择文件</div>
					<div class="content">
						<input type="file" class="picture" name="file">
					</div>
				</div>
				<div class="post-item">
				...
				<input type="hidden" name="bbid" value="8">
