	...
	<div class="layui-layout layui-layout-admin">
		...
		<div class="page-content">
			<div class="layui-row" style="margin-bottom: 10px;">
				...
				<a class="layui-btn" href="${pageContext.request.contextPath}/view/jsp/uploadVideoSource.jsp">上传视频</a>
			</div>
			<div class="layui-row">
						...
						<tr>
							...
							<td class="td-manage">
								<div class="layui-btn-group">
										...
										<a class="layui-btn layui-btn-sm" href="${pageContext.request.contextPath }/source/AlookVid?sid=${source.sid }">浏览</a>
									
									<a class="layui-btn layui-btn-sm" href="${pageContext.request.contextPath }/source/Vdelete?sid=${source.sid }">删除</a>
								</div>
							</td>
						</tr>
					</c:forEach>
			...
			<div class="page">
				<a href="${pageContext.request.contextPath }/source/getToAdminVideo?pn=${pageInfo.navigateFirstPage}&bbid=6">首页</a>
				<c:if test="${pageInfo.hasPreviousPage}">
					<a href="${pageContext.request.contextPath }/source/getToAdminVideo?pn=${pageInfo.prePage}&bbid=6">上一页</a>
				</c:if>
				<c:if test="${!pageInfo.hasPreviousPage}">
					<a class="disabled-link">上一页</a>
				</c:if>
				<c:if test="${pageInfo.hasNextPage}">
					<a href="${pageContext.request.contextPath }/source/getToAdminVideo?pn=${pageInfo.nextPage}&bbid=6">下一页</a>
				</c:if>
				<c:if test="${! pageInfo.hasNextPage}">
					<a class="disabled-link">下一页</a>
				</c:if>
				<a href="${pageContext.request.contextPath }/source/getToAdminVideo?pn=${pageInfo.navigateLastPage}&bbid=6">尾页</a>
